...
|state|[microsoft.graph.conditionalAccessPolicyState](#microsoftgraphconditionalaccessconditions) |Specifies state of the policy, including Enabled, Disabled, and LogOnly.|
